...
mscDetectorConstruction::~mscDetectorConstruction()
{ 
G4cout<<"Construct with target 1 made out of "<<targetMaterial<<" of Length "<<targetLen/cm<<" cm and target 2 made out of "<<targetMaterial2<<" of Length "<<targetLen2/cm<<" cm."<<G4endl;
}
...
G4VPhysicalVolume* mscDetectorConstruction::Construct()
{
  ...
  if ( !tgtMaterial || !tgtMaterial2 || !vacuumMaterial) {
  ...
  G4Colour  cyan(0/255.,255/255.,255/255.);
  G4VisAttributes* tgtVisAtt = new G4VisAttributes(cyan);
 ...
 G4VisAttributes* tgtVisAtt2 = new G4VisAttributes(blue);
